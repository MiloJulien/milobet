...
export default function Footer() {
  ...
  const tabs = [
    ...
    },
    {
     ...
     {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-distribute-vertical" viewBox="0 0 16 16">
    ...
    >
      <nav className="container mx-auto flex justify-between items-center h-full p-4">
        ...
        {session && (
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-person-fill-x" viewBox="0 0 16 16">
